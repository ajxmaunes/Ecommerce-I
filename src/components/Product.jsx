...
const Product = ({product}) => {
  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] hover:border-2 hover:border-gray-600 h-[300px] mb-4 relative overflow-hidden group transition'>
      ...
      <div>
        ...
        <Link to={`/product/${id}`}>
          <h2 className='font-semibold mb-1 text-[15px]'>{title}</h2>
        </Link>
