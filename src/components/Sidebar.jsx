...
const Sidebar = () => {
  ...
  return <div className={`${isOpen ? 'right-0' : '-right-full'} w-full bg-white fixed top-0 h-full shadow-2xl md:max-w-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
