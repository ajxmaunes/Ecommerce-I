    ...
    return (
        <section className="page h-[40rem] mt-[2rem] w-[100%] flex flex-col justify-center items-center text-[0.75rem] m-0 box-border">
                <div className="cover w-[90%] h-[520px] py-4 relative rounded-[1rem] flex flex-col items-center justify-around md:w-[40%]">
                    ...
                    <input name="email" className="w-[85%] border-[1px] border-[#232A4E] text-center p-[10px] text-[1rem]" type="text" placeholder="username" />
                    <input name="password" className="w-[85%] border-[1px] border-[#232A4E] text-center p-[10px] text-[1rem]" type="password" placeholder="password" />
